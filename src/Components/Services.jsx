...
import { ChevronLeft, ChevronRight, ExternalLink, Code, Smartphone, ShoppingCart, ArrowRight, Check, Play, Pause, Sparkles } from "lucide-react";
...
const ServicesSlider = () => {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.span 
            ...
            className="inline-flex items-center text-blue-600 font-semibold text-sm md:text-lg mb-2 px-4 py-2 rounded-full bg-blue-900/30 backdrop-blur-sm"
          >
  ...
  className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl overflow-hidden border border-gray-200 hover:shadow-3xl transition-all duration-500"
>
  <div className="flex flex-col lg:flex-row gap-0">
    ...
    <div className="relative overflow-hidden group lg:w-1/2">
      ...
      <div className={`absolute top-6 left-6 w-14 h-14 rounded-2xl bg-gradient-to-r ${service.color} flex items-center justify-center text-white shadow-lg`}>
        {service.icon}
      </div>
    </div>
